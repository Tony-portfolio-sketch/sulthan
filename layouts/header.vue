<template>
    <div>
        ...
        <nav class="parallax fixed flex flex-row justify-between items-center w-full px-6 py-4 z-10 text-white">
            ...
            <div class="md:hidden">
                ...
                <div v-if="isMobileMenuOpen"
                    class="absolute mt-[18px] left-0 w-full bg-white text-[#484848] border-t shadow">
        ...
        <div id="hero" class="top-content mb-8">
            <img class="w-full bg-cover" src="/assets/img/hero-bg.png" alt="">
            <div
                class="md:absolute md:max-w-[391px] max-h-[588px] bg-white rounded-[4px] md:top-[132px] md:left-[80px] px-4 md:px-6 py-2 md:py-8">
                ...
                <div class="w-full mt-6">
                    ...
                    <input type="text"
                        class="w-full h-[48px] border rounded-[2px] text-[#484848] placeholder-[#8F8F8F] text-[16px] font-normal mt-2 px-4 py-4"
                        placeholder="Partout">
                </div>
                <div class="flex flex-row w-full mt-4">
                    <div>
                        ...
                        <input type="date"
                            class="w-full h-[48px] border rounded-l-[2px] text-[#484848] placeholder-[#8F8F8F] text-[16px] font-normal mt-2 px-4 py-4"
                            placeholder="Arrivée">
                    </div>
                    <div>
                        ...
                        <input type="time"
                            class="w-full h-[48px] border rounded-r-[2px] text-[#484848] placeholder-[#8F8F8F] text-[16px] font-normal mt-2 px-4 py-4 "
                            placeholder="Départ">
                    </div>
                </div>
...
const nav = ref(null);
const navBrandSrc = ref('/assets/icons/airbnb-nav.png');
...
const onScroll = () => {
    if (document.documentElement.scrollTop > 60 || document.body.scrollTop > 60) {
        ...
        navBrandSrc.value = '/assets/icons/airbnb-nav-red.png';
    } else {
        nav.value.classList.remove('bg-white', 'items-center', 'shadow');
        nav.value.classList.add('text-white');
        navBrandSrc.value = '/assets/icons/airbnb-nav.png';
    }
};
